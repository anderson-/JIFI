package robotinterface.gui.panels.code.jedit;
...
import static robotinterface.gui.panels.code.jedit.InputHandler.REPEAT;
...
public class DefaultInputHandler extends InputHandler {
    ...
    public void addDefaultKeyBindings() {
        ...
        addKeyBinding("C+x", new cut());
        addKeyBinding("C+c", new copy());
        addKeyBinding("C+v", new paste());

        addKeyBinding("}", new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ...
                // TODO: identar ao fechar colchetes
                int line = textArea.getCaretLine();
                String lineText = textArea.getLineText(line);
                lineText = lineText.replaceFirst("\t", "") + "}";
                int start = textArea.getLineStartOffset(line);
                textArea.select(start, textArea.getCaretPosition());
                textArea.setSelectedText(lineText);
            }
        });
    }
     ...
     * white space separated key strokes of the form
     * <i>[modifiers+]key</i> where modifier is C for Control, A for Alt, or S
     * for Shift, and key is either a character (a-z) or a field name in the
     * KeyEvent class prefixed with VK_ (e.g., BACK_SPACE)
     *
     ...
     * <i>modifiers</i>+<i>shortcut</i> where <i>modifiers</i>
     * is any combination of A for Alt, C for Control, S for Shift or M for
     * Meta, and <i>shortcut</i> is either a single character, or a keycode name
