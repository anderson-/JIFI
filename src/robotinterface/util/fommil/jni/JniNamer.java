package robotinterface.util.fommil.jni;
...
public class JniNamer {
    ...
    public static String arch() {
        ...
        GUI.getLogger().warning("unrecognised architecture: " + arch);
        return "unknown";
    ...
    public static String abi(String arch) {
        ...
        try {
            ...
            for (String prop : new String[]{"sun.boot.library.path", "java.library.path", "java.home"}) {
                ...
                GUI.getLogger().config(prop + ": " + value);
            ...
            GUI.getLogger().log(WARNING, "unable to detect ABI", e);
            return "unknown";
        }
    }
    ...
    public static String os() {
        ...
        GUI.getLogger().warning("unable to detect OS type: " + os);
        return "unknown";
    }
