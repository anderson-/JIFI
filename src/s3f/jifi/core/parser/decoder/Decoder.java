...
import s3f.jifi.core.interpreter.Get;
...
import s3f.jifi.core.parser.parameterparser.ParameterParser;
import s3f.jifi.flowchart.*;
...
public class Decoder implements DecoderConstants {
  ...
  private void checkVar() throws ParseException
  {
    ...
    List<ConstantsProvider> providers = em.getAllProperties("s3f.jifi.constants.*", "provider", ConstantsProvider.class);
    if (providers != null) {
        search:
        for (ConstantsProvider p : providers) {
            for (String v : p.getNames()) {
                if (v.equals(token.toString())) {
                    error = false;
                    break search;
                }
            }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x80,0x0,0x0,0x4000000,0xd10000,0x0,0xd10000,0xd10000,0x0,0x0,0x0,0x0,0x0,0x20000000,0x20000000,0xd8000000,0xd8000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xd10000,0x0,0xd10000,0x0,0x0,0x0,0x510000,0x800000,0x510000,0x0,0xd10000,0xd1b2e0,0xd10000,0xd1b2e0,0x0,0xd10000,0x200,0x400,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x100000,0x20000,0x0,0x6022078,0x100000,0x6022078,0x6002078,0x2,0x4,0x400,0x800,0x200,0x1,0x1,0x0,0x0,0x1c00000,0x1c00000,0x60,0x60,0x1180,0x1180,0x60,0x6002078,0x6000000,0x6002000,0x18,0x18,0x220000,0x0,0x2000,0x0,0x220000,0x0,0x608a078,0x6002078,0x608a078,0x100000,0x6002078,0x8000,0x0,};
   }
