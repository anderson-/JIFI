/* Generated By:JavaCC: Do not edit this line. FlowchartBuilder.java */
package s3f.jifi.flowchart.builder.parser;
...
import s3f.jifi.flowchart.builder.Parser;
import s3f.jifi.flowchart.parameterparser.Argument;
import s3f.jifi.flowchart.parameterparser.ParameterParser;
import s3f.jifi.flowchart.syntax.FunctionToken;

public class FlowchartBuilder implements FlowchartBuilderConstants {
  ...
  {
    FlowchartBuilder parser = new FlowchartBuilder(System.in);
  ...
  final public ScriptBlock decode() throws ParseException {
  ScriptBlock function = new ScriptBlock();
  localBlock = function;
    label_1:
    while (true) {
  ...
  ;
    ...
    case BREAK:
      ...
      jj_consume_token(SEMICOLON);
    block.add(new Procedure("break;"));
      break;
    case RETURN:
      jj_consume_token(RETURN);
    Procedure r = new Procedure("return ...;");
    block.add(r);
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case INTEGER_LITERAL:
      case FLOATING_POINT_LITERAL:
      ...
      m = mark();
        expression();
      String ex = getString(m);
      r.addLineArg(0, Argument.EXPRESSION, ex);
        break;
      default:
        jj_la1[37] = jj_gen;
        ;
  ...
  Token functionID;
    ...
    boolean error = false;//TODO: true
    EntityManager em = PluginManager.getInstance().createFactoryManager(null);
    List<FunctionToken> list = em.getAllProperties("s3f.jifi.cmd.*", "procedure", FunctionToken.class);
    for (FunctionToken ftoken : list) {
    ...
    for (s3f.core.project.Element e : project.getElements()) {
        //if (e instanceof Flowchart) {
            //jep.addFunction(((Flowchart) e).getName(), new PostfixMathCommand());
            //jep.addFunction(((Flowchart) e).getName(), new PostfixMathCommand());
        //}
    }
    if (error)
  ...
  final public void doWhileStatement(Block b) throws ParseException {
  ...
  public FlowchartBuilderTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0xd1b2e0,0x80,0x0,0x0,0x4000000,0xd10000,0x0,0xd10000,0xd10000,0x0,0x0,0x0,0x0,0x0,0x20000000,0x20000000,0xd8000000,0xd8000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xd10000,0x0,0xd10000,0x0,0x0,0x0,0x510000,0x800000,0x510000,0x0,0xd10000,0xd1b2e0,0xd10000,0xd1b2e0,0x0,0xd10000,0x200,0x400,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x608a078,0x0,0x100000,0x20000,0x0,0x6022078,0x100000,0x6022078,0x6002078,0x2,0x4,0x400,0x800,0x200,0x1,0x1,0x0,0x0,0x1c00000,0x1c00000,0x60,0x60,0x1180,0x1180,0x60,0x6002078,0x6000000,0x6002000,0x18,0x18,0x220000,0x0,0x2000,0x0,0x220000,0x0,0x608a078,0x6002078,0x608a078,0x100000,0x6002078,0x8000,0x0,};
   }
  ...
  public FlowchartBuilder(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public FlowchartBuilder(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new JavaCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new FlowchartBuilderTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public FlowchartBuilder(java.io.Reader stream) {
  ...
  public FlowchartBuilder(FlowchartBuilderTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(FlowchartBuilderTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
