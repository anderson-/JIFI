 ...
 */
package jifi.ui.view.tabbedpaneview;
...
import jifi.ui.view.tabbedpaneview.dndtabbedpane.ButtonTabComponent;
import jifi.ui.view.tabbedpaneview.dndtabbedpane.DnDTabbedPane;
import jifi.ui.view.tabbedpaneview.dndtabbedpane.TabComponent;
...
public class TabbedPaneView {
        ...
        tabbedPane.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                if (tabbedPane.getTabCount() > 0) {
                    View view = getView(tabbedPane.getSelectedComponent());
                    if (view != null) {
                        view.selected();
                    }
                }
    ...
    public View getView(Component component) {
        for (View view : views) {
            if (component.equals(view.getData().getComponent())) {
                return view;
            }
        }
        return null;
    ...
    public void add(View view) {
        if (jSplitPanel.isSplitted()) {
            ...
            this.getDnDTabbedPane().addTab("", null, view.getData().getComponent(), view.getData().getToolTip());
            views.add(view);
