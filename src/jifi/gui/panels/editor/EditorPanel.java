...
//import jifi.gui.panels.code.jedit.*;
//import static jifi.gui.panels.code.jedit.InputHandler.BACKSPACE;
//import static jifi.gui.panels.code.jedit.InputHandler.BACKSPACE_WORD;
//import static jifi.gui.panels.code.jedit.InputHandler.DELETE;
//import static jifi.gui.panels.code.jedit.InputHandler.DELETE_WORD;
//import static jifi.gui.panels.code.jedit.InputHandler.INSERT_BREAK;
//import static jifi.gui.panels.code.jedit.InputHandler.INSERT_TAB;
//import static jifi.gui.panels.code.jedit.InputHandler.getTextArea;
//import jifi.gui.panels.robot.RobotControlPanel;
//import jifi.plugin.PluginManager;
//import jifi.robot.device.Device;
//import jifi.util.cyzx.Undoable;
//import jifi.util.cyzx.HistoryManager;
//
///**
// *
// * @author antunes
...
//
//        for (Class c : PluginManager.getPluginsAlpha("jifi/plugin/cmdpack/plugin.txt", FunctionToken.class
//        )) {
...
//
//}
package jifi.gui.panels.editor;
...
import jifi.algorithm.parser.Parser;
import jifi.algorithm.procedure.Function;
import jifi.gui.panels.editor.syntaxtextarea.FunctionTokenMaker;
import jifi.gui.panels.robot.RobotControlPanel;
import jifi.plugin.PluginManager;
import jifi.robot.device.Device;
